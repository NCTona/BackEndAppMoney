...
public interface TransactionRepository
        ...
        @Query("SELECT t FROM TransactionEntity t WHERE t.transactionDate BETWEEN ?1 AND ?2 ORDER BY t.transactionDate ASC")
        List<TransactionEntity> findAllByDateBetween(LocalDate startDate, LocalDate endDate);
        ...
        boolean existsByUserIdAndTransactionDateAndCategoryIdAAndFixedTransactionId(Long userId,
                        LocalDate transactionDate, Long categoryId, Long fixedTransactionId);
        ...
        void deleteByUserIdAndFixedTransactionIdAndTransactionDateBetween(Long userId, Long fixedTransactionId,
